...
module "aks" {
  ...
  admin_group_object_ids            = [data.azuread_group.admin-group-preprod.id]
  ...
  vnet_id = data.azurerm_virtual_network.vnet_preprod.id
